...
const DA_TENERE = [
  ...
  "./js/storico/allenamenti-stimati.js",
  "./js/admin/gestione-utenti.js",
  "./js/admin/salute-app.js",
  "./js/admin/registro-accessi.js",
  "./js/admin/console-proprietario.js",
  "./js/admin/console-pagine.js",
  "./js/home/home.js",
